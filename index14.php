...
if (!empty($_POST))
{
    setcookie("q11", $_POST["mcq"], time() + (86400 * 30), "/");
}
include 'header.php';

$sql = 'SELECT question FROM question WHERE q_id = 12';
$q = $conn->query($sql);
$row = $q->fetchObject();
  ...
  aria-valuemin="0" aria-valuemax="100" style="width:96%">
    ...
    <div class="container">
        ...
        <div class="survey-container">
                <div class="label1">
                    <label><?php echo $row->question;?><br/>&nbsp;<img src='img/battery.png'/>&nbsp;<img src='img/page-speed-interface-symbol.png'/>&nbsp;<img src='img/money-bag.png'/></label>
                </div>
                <div class="row-container">
                    <?php 
                    
                    echo "<form id='mcForm' name='mcForm' method='POST' action='cookie.php'>";
