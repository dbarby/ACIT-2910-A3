...
// Facade
    ...
    //Q3
        if($_COOKIE[q3] == 1){
            $Q3A = "graphics_rating <= 2";
        }elseif ($_COOKIE[q3] == 2){
            $Q3A = "graphics_rating <= 3 AND graphics_rating >= 2";
        }else if ($_COOKIE[q3] == 3){
            $Q3A = "graphics_rating <= 5 AND graphics_rating >= 4";
        }else if ($_COOKIE[q3] == 4){
            $Q3A = "graphics_rating = 5 AND battery > 10";
        }
    //Q4
        if($_COOKIE[q4] == 1){
