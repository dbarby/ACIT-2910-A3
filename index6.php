...
$sql = 'SELECT question FROM question WHERE q_id = 4';
$q = $conn->query($sql);
$row = $q->fetchObject();
  ...
  aria-valuemin="0" aria-valuemax="100" style="width:32%">
    ...
    <div class="container">
        ...
        <div class="survey-container">
                <div class="label1">
                    <label><?php echo $row->question;?>&nbsp; &nbsp; &nbsp;<img src='img/image.png'/></label>
                </div>
                <div class="row-container">
                    <?php 
                    
                    echo "<form id='mcForm' name='mcForm' method='POST' action='index7.php'>";
