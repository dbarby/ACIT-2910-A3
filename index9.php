...
if (!empty($_POST))
{
    setcookie("q6", $_POST["mcq"], time() + (86400 * 30), "/");
}
include 'header.php';

$sql = 'SELECT question FROM question WHERE q_id = 7';
$q = $conn->query($sql);
$row = $q->fetchObject();
  ...
  aria-valuemin="0" aria-valuemax="100" style="width:56%">
    ...
    <div class="container">
        ...
        <div class="survey-container">
                <div class="label1">
                    <label><?php echo $row->question;?>&nbsp; &nbsp; &nbsp;<img src='img/hard-drive-with-an-arrow-pointing-down.png'/></label>
                </div>
                <div class="row-container">
                    <?php 
                    
                    echo "<form id='mcForm' name='mcForm' method='POST' action='index10.php'>";
